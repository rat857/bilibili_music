...
func GetCid(aid string) (cid, title string) {
	...
	var cidForGet GetCidStruct
	body, _ := io.ReadAll(res.Body)
	json.Unmarshal(body, &cidForGet)
	return strconv.Itoa(cidForGet.Data.Cid), cidForGet.Data.Title
}
